...
class TextWatermarkBot:
    ...
    async def process_video(self, message: Message, video_path: str):
        ...
        try:
            ...
            # Step 1: Compress if too large (over 500MB)
            ...
            if file_size_mb > 500:
                ...
                if compressed:
                    ...
                    await status_msg.edit_text(f"✅ Compressed: {file_size_mb:.1f}MB → {compressed_size:.1f}MB")
                else:
                    await status_msg.edit_text("⚠️ Compression failed, using original")
